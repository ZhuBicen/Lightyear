...
public:
	...
	//
	static void InsertImage(IRichEditOle* pRichEditOle, const std::wstring& imagePath);

    static void InsertImage(IRichEditOle* pRichEditOle, HBITMAP p_hbitmap);
...
public:
    void SetStringId(const std::wstring& id) {
        m_stringId = id;
    }
